...
class ddKnife : ddFist
{
	...
	override State GetRefireState()
	{
		...
		{
			if(caseno == 0) { caseno = 1; return FindState("Fire2"); }
			else { caseno = 0; return FindState("Fire"); }
		}
	}
